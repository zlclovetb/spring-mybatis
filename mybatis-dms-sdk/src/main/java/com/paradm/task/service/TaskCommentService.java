...
public interface TaskCommentService {
     ...
     * @return 返回数据的数量
     */
    int countByExample(TaskCommentExample example);
     ...
     * @return 返回添加成功的数量
     */
    int insertBatch(List<TaskComment> record);
     ...
     * @return 返回添加成功的数量
     */
    int insertBatchSelective(List<TaskComment> record);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExampleSelective(TaskComment record, TaskCommentExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExample(TaskComment record, TaskCommentExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKeySelective(List<TaskComment> records);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKey(List<TaskComment> records);
}