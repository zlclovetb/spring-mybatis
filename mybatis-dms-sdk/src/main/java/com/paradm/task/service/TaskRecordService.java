...
public interface TaskRecordService {
     ...
     * @return 返回添加成功的数量
     */
    int insertBatch(List<TaskRecord> record);
     ...
     * @return 返回添加成功的数量
     */
    int insertBatchSelective(List<TaskRecord> record);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExampleSelective(TaskRecord record, TaskRecordExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExample(TaskRecord record, TaskRecordExample example);
     ...
     * @return 返回查询的结果
     */
    List<TaskRecord> selectByExampleWithBLOBs(TaskRecordExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKeySelective(List<TaskRecord> records);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKey(List<TaskRecord> records);
}