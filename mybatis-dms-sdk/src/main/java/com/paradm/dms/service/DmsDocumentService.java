...
public interface DmsDocumentService {
     ...
     * @return 返回数据的数量
     */
    int countByExample(DmsDocumentExample example);
     ...
     * @return 返回添加成功的数量
     */
    int insertBatch(List<DmsDocument> record);
     ...
     * @return 返回添加成功的数量
     */
    int insertBatchSelective(List<DmsDocument> record);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExampleSelective(DmsDocument record, DmsDocumentExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExample(DmsDocument record, DmsDocumentExample example);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKeySelective(List<DmsDocument> records);
     ...
     * @return 返回更新成功的数量
     */
    int updateBatchByPrimaryKey(List<DmsDocument> records);
}